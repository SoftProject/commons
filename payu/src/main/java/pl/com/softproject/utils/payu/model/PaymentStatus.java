...
{
  S1("1", "nowa"),  S2("2", "anulowana"),  S3("3", "odrzucona"),  S4("4", "rozpoczeta"),  S5("5", "oczekuje na odbior"),  S6("6", "autoryzacja odmowna"),  S7("7", "platnosc odrzucona"),  S99("99", "platnosc odebrana - zakonczona"),  S888("888", "bledny status"),  S0("0", "błąd");
