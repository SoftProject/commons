...
public class StringUtilTest {
    ...
    public void testSplitLinesAsList() {
        ...
        List<String> res = StringUtil.splitLinesAsList("bardzo długi tekst, ponad 30 znaków w jednej linii tekstu.. Trzeba go podzielić.", len);
    ...
    public void testSplitLinesAsListNoWithChars() {
        ...
        List<String> res = StringUtil.splitLinesAsList("bardzodługitekst,ponad30znakówwjednejliniitekstu.Trzebagopodzielić.", len);
    ...
    public void testSplitLinesAsListShort() {
        ...
        assert res.size() == 1 : "za dużo elementów w res";
        
        assert res.get(0).equals(str) : "nieprawidłowy tekst";
